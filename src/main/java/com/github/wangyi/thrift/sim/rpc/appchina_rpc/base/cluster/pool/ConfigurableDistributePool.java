...
import com.github.wangyi.thrift.sim.rpc.appchina_rpc.base.cluster.LoadBalance;
import com.github.wangyi.thrift.sim.rpc.appchina_rpc.base.cluster.RandomLoadBalance;
...
public abstract class ConfigurableDistributePool<P,R> {
	 ...
	 * 负载均衡
	 * */
	protected LoadBalance loadBalance = new RandomLoadBalance();
	/**
	 * 心跳频率，小于0时禁用
	 * */
